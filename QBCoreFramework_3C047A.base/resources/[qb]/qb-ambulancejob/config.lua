...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ...
    ["armory"] = {
        [1] = vector3(306.8, -601.91, 43.28),
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(332.32, -595.72, 43.28),
    },
    ["stash"] = {
        [1] = vector3(302.13, -599.11, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(324.4, -582.57, 44.2, 169.15), taken = false, model = 1631638868},
        [2] = {coords = vector4(319.29, -580.99, 44.2, 154.56), taken = false, model = 1631638868},
        [3] = {coords = vector4(313.67, -579.05, 44.2, 159.83), taken = false, model = 2117668672},
        [4] = {coords = vector4(309.15, -577.44, 44.2, 154.4), taken = false, model = 2117668672},
        [5] = {coords = vector4(307.74, -581.79, 44.2, 339.63), taken = false, model = 2117668672},
        [6] = {coords = vector4(311.24, -582.75, 44.2, 338.8), taken = false, model = -1091386327},
        [7] = {coords = vector4(314.67, -584.26, 44.2, 339.94), taken = false, model = -1091386327},
        [8] = {coords = vector4(317.8, -585.39, 44.2, 337.23), taken = false, model = -1091386327},
	--- paleto
