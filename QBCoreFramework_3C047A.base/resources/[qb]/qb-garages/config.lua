...
Config.Garages = {
    ...
    ['yakuza'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(-1521.380859375, 78.1205368042),
                vector2(-1520.323852539, 71.480857849122),
                vector2(-1531.4509277344, 68.835235595704),
                vector2(-1536.5520019532, 69.77239227295),
                vector2(-1544.0378417968, 77.05615234375),
                vector2(-1539.3662109375, 81.813850402832),
                vector2(-1538.173461914, 80.667358398438),
                vector2(-1537.3682861328, 81.161643981934),
                vector2(-1532.9938964844, 77.143348693848)

            },
            ['minZ'] = 54.55,  -- min height of the parking zone
            ['maxZ'] = 58.55,  -- max height of the parking zone
        },
        label = 'yakuza Parking',
        showBlip = false,
        blipcoords = vector3(365.92, -10.53, 83.0),
        blipName = 'gang Parking',
        blipNumber = 357,
        type = 'gang',
        gang = 'yakuza',
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(-1523.41, 74.38, 56.75, 8.29),
            vector4(-1527.87, 73.8, 56.75, 5.28),
            vector4(-1537.9, 76.5, 56.75, 314.54),
        }
    },
    ['doctorparking'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(319.33911132812, -538.54602050782),
                vector2(319.50799560546, -544.03405761718),
                vector2(313.55563354492, -543.79553222656),
                vector2(313.55966186524, -538.62860107422)

            },
            ['minZ'] = 28.34,  -- min height of the parking zone
            ['maxZ'] = 32.34,  -- max height of the parking zone
        },
        label = 'Doctor Parking',
        showBlip = false,
        blipcoords = vector3(365.92, -10.53, 83.0),
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(316.34, -541.12, 28.74, 276.16),
        }
    },
    ['apartmentgarage'] = {
        ['Zone'] = {
            ['Shape'] = {
                vector2(343.93716430664, -7.8960437774658),
                vector2(356.07873535156, 1.902327299118),
                vector2(360.6079711914, -4.2299146652222),
                vector2(367.3146057129, -12.623433113098),
                vector2(375.65798950196, -5.6460781097412),
                vector2(365.60330200196, 8.5426683425904),
                vector2(371.3203125, 12.882798194886),
                vector2(384.87292480468, -4.6260404586792),
                vector2(374.82818603516, -11.576586723328),
                vector2(377.11962890625, -14.668276786804),
                vector2(353.2303161621, -33.504878997802),
                vector2(342.32458496094, -19.217475891114),
                vector2(348.23809814454, -14.227505683898)
            },
            ['minZ'] = 80.99,  -- min height of the parking zone
            ['maxZ'] = 84.99,  -- max height of the parking zone
        },
        label = 'Unreal Hottel Parking',
        showBlip = true,
        blipcoords = vector3(365.92, -10.53, 83.0),
        blipName = 'Public Parking',
        blipNumber = 357,
        ...
        debug = false,
        ['ParkingSpots'] = {
            vector4(347.29, -9.7, 83.0, 223.87),
            vector4(350.36, -7.22, 83.0, 223.87),
            vector4(353.53, -4.69, 83.0, 223.87),
            vector4(356.86, -2.39, 83.0, 223.87),
            vector4(370.62, 7.84, 82.98, 127.59),
            vector4(373.0, 4.87, 82.98, 127.59),
            vector4(375.46, 1.68, 82.98, 127.59),
            vector4(377.92, -1.57, 82.98, 127.59),
            vector4(380.49, -4.73, 82.98, 127.59),
            vector4(373.13, -12.97, 82.99, 39.3),
            vector4(369.78, -15.4, 82.99, 39.3),
            vector4(366.59, -17.78, 82.99, 39.3),
            vector4(363.6, -20.34, 82.99, 39.3),
            vector4(353.84, -27.53, 83.0, 313.42),
            vector4(351.21, -24.47, 83.0, 313.42),
            vector4(348.67, -21.35, 83.0, 313.42),
        }
    },
    ['pillboxgarage'] = {
        ['Zone'] = {
