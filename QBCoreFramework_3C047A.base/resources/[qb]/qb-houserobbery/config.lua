...
Config.Rewards = {
    [1] = {
        ["cabin"] = {"plastic", "diamond_ring", "goldchain", "weed_skunk", "thermite", "weapon_golfclub", "metal_spring"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain", "water_bottle"},
        ["chest"] = {"plastic", "rolex", "diamond_ring", "goldchain", "weed_skunk", "thermite", "weapon_barrel", "weapon_grip"},
