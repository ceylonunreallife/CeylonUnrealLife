...
QBCore.Functions.CreateUseableItem("Chuhai", function(source, item)
    ...
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:Chuhai", source, item.name)
    end
end)
...
QBCore.Functions.CreateUseableItem("Takoyaki", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
...
QBCore.Functions.CreateUseableItem("Ramen", function(source, item)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:Ramen", source, item.name)
    end
end)
QBCore.Functions.CreateUseableItem("Sashimi", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:Sashimi", source, item.name)
    end
end)
QBCore.Functions.CreateUseableItem("Onigiri", function(source, item)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:Onigiri", source, item.name)
    end
end)
...
QBCore.Functions.CreateUseableItem("Misosoup", function(source, item)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:Misosoup", source, item.name)
    end
end)
...
QBCore.Functions.CreateUseableItem("jcafebubbleteablueberry", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:jcafebubbleteablueberry", source, item.name)
    end
end)
QBCore.Functions.CreateUseableItem("jcafebubbletearose", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:jcafebubbleteablueberry", source, item.name)
...
QBCore.Functions.CreateUseableItem("jcafebubbleteamint", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:jcafebubbleteablueberry", source, item.name)
...
QBCore.Functions.CreateUseableItem("jcafecupcake", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:EatDonut", source, item.name)
...
QBCore.Functions.CreateUseableItem("jcafevanillasandy", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:jcafevanillasandy", source, item.name)
    end
end)
QBCore.Functions.CreateUseableItem("jcafechocsandy", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:jcafechocsandy", source, item.name)
    end
end)
QBCore.Functions.CreateUseableItem("jcafebudhabowl", function(source, item)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:jcafebudhabowl", source, item.name)
    end
end)
QBCore.Functions.CreateUseableItem("jcafesushi", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:EatPancakes", source, item.name)
...
QBCore.Functions.CreateUseableItem("jcafemisosoup", function(source, item)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.RemoveItem(item.name, 1, item.slot) then
        TriggerClientEvent("consumables:client:jcafemisosoup", source, item.name)
    end
end)
