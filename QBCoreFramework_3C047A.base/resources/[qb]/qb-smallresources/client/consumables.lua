...
RegisterNetEvent("consumables:client:Chuhai", function(itemName)
...
RegisterNetEvent("consumables:client:Misosoup", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"Sushi"})
    action = true
...
RegisterNetEvent("consumables:client:Onigiri", function(itemName)
...
RegisterNetEvent("consumables:client:Ramen", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"jcafesandy"})
    action = true
    QBCore.Functions.Progressbar("eat_something", "jcafe Icecream Mmm..", 10000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent("consumables:client:Sashimi", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"jcafesandy"})
    action = true
    QBCore.Functions.Progressbar("eat_something", "jcafe Icecream Mmm..", 10000, false, true, {
        disableMovement = false,
...
--update event below to use the "jcafesandy" emote to change the prop
...
--jcafe Cafe
RegisterNetEvent("consumables:client:jcafebubbleteablueberry", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"bubbletea"})
    action = true
    QBCore.Functions.Progressbar("drink_something", "Popping some Bubble Tea..", 10000, false, true, {
        disableMovement = false,
...
RegisterNetEvent("consumables:client:jcafemisosoup", function(itemName)
...
RegisterNetEvent("consumables:client:jcafebudhabowl", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"budhabowl"})
    action = true
    QBCore.Functions.Progressbar("eat_something", "Banging a bowl of goodness..", 10000, false, true, {
        disableMovement = false,
...
RegisterNetEvent("consumables:client:jcafevanillasandy", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"jcafesandy"})
    action = true
    QBCore.Functions.Progressbar("eat_something", "jcafe Icecream Mmm..", 10000, false, true, {
        disableMovement = false,
...
RegisterNetEvent("consumables:client:jcafechocsandy", function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"jcafesandy"})
    action = true
    QBCore.Functions.Progressbar("eat_something", "jcafe Icecream Mmm..", 10000, false, true, {
        disableMovement = false,
