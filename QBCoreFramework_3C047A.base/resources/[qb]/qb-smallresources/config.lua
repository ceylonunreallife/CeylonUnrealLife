...
Config.Discord = {
    ...
    ["ApplicationId"] = '1098932663655608350', -- The discord application id
    ["IconLarge"] = 'ur_logo2', -- The name of the large icon
    ["IconLargeHoverText"] = 'This is a Large icon with text', -- The hover text of the large icon
    ["IconSmall"] = 'ur_logo2', -- The name of the small icon
    ...
    ["Buttons"] = {
        {
            text = 'Discord',
            url = 'ttps://discord.gg/JSVTbJYmT2'
        },
--        {
--            text = 'Second Button!',
...
Config.ConsumablesEat = {
    ...
    ["twerks_candy"] = math.random(10, 14),
    ...
    ["jcafepancake"] = math.random(25, 34),
    ["jcafebudhabowl"] = math.random(50, 60),
    ["jcafesushi"] = math.random(45, 50),
    ["jcafecupcake"] = math.random(40, 45),
    ["jcafevanillasandy"] = math.random(50, 65),
    ["jcafechocsandy"] = math.random(50, 65),

    ["onigiri"] = math.random(50, 65),
    ["tonkatsu"] = math.random(50, 65),
    ["ramen"] = math.random(50, 65),
    ["tofu"] = math.random(50, 65),
    ["sushi"] = math.random(50, 65),
    ["jcafepancake"] = math.random(50, 65),
    ["jcafebudhabowl"] = math.random(50, 65),
    ["misosoup"] = math.random(50, 65),
    ["waffle-nutela"] = math.random(50, 65),
    ["pastel-frango"] = math.random(50, 65),
    ["muffin-chocolate"] = math.random(50, 65),

}

Config.ConsumablesDrink = {
    ["water_bottle"] = math.random(10, 15),
    ["kurkakola"] = math.random(5, 14),
    ["coffee"] = math.random(5, 10),
    ["apple_juice"] = math.random(25, 45),
    ["grapejuice"] = math.random(25, 45),
    ["hotsauce"] = math.random(10, 15),

    ["jcafebubbleteablueberry"] = math.random(55, 60),
    ["jcafebubbletearose"] = math.random(55, 60),
    ["jcafebubbleteamint"] = math.random(55, 60),
    ["jcafemisosoup"] = math.random(80, 90),

    ["cafe-jcafe"] = math.random(55, 60),
    ["latte-jcafe"] = math.random(55, 60),
    ["bubble-amora"] = math.random(55, 60),
    ["bubble-menta"] = math.random(80, 90),
    ["yakult"] = math.random(55, 60),
    ["aloedrinks"] = math.random(55, 60),
    ["chuhai"] = math.random(70, 90),
}
...
Config.Teleports = {
    ...
    [1] = {
            [1] = {
                ['poly'] = {
                coords = vector3(380.28, -15.14, 83.0),
                heading = 51.16,
                length = 2,
                width = 2
               },
         ...
         [2] = {
                ['poly'] = {
                coords = vector3(417.43, -10.7, 99.65),
                heading = 239.96,
                length = 2,
                width = 2
               },
               ["AllowVehicle"] = false,
               label = 'Enter Appartment'
               }
     ...
     [2] = {
        [1] = {
            ['poly'] = {
            coords = vector3(319.58, -560.14, 28.74),
            heading = 28.63,
            length = 2,
            width = 2
            },
        ...
        [2] = {
            ['poly'] = {
            coords = vector3(326.88, -603.69, 43.28),
            heading = 346.91,
            length = 2,
            width = 2
            },
