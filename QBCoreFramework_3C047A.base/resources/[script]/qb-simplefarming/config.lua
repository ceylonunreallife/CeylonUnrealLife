...
Config.Sell = {
    ["apple"] = {
        ["price"] = math.random(180, 200)                  -- Seller Price
    },
    ["apple_juice"] = {
        ["price"] = math.random(500, 650)
    },
    ["milkbucket"] = {
        ["price"] = math.random(325, 435)
    },
    ["raw_beef"] = {
        ["price"] = math.random(225, 335)
    },
    ["beef"] = {
        ["price"] = math.random(325, 435)
    },
    ["milk"] = {
        ["price"] = math.random(725, 835)
    },
    ["rawpumpkin"] = {
        ["price"] = math.random(325, 435)
    },
    ...
    ["tomato"] = {
        ["price"] = math.random(225, 235)
    },
    ["tomatopaste"] = {
        ["price"] = math.random(525, 635)
    },
    ["raw_bacon"] = {
        ["price"] = math.random(425, 535)
    },
    ["raw_sausage"] = {
        ["price"] = math.random(525, 635)
    },
    ...
    ["cooked_bacon"] = {
        ["price"] = math.random(425, 635)
    },
    ["cooked_sausage"] = {
        ["price"] = math.random(425, 835)
    },
    ["cooked_pork"] = {
        ["price"] = math.random(425, 635)
    },
    ["cooked_ham"] = {
        ["price"] = math.random(625, 835)
    },
    ["pig_leather"] = {
        ["price"] = math.random(625, 835)
    },
