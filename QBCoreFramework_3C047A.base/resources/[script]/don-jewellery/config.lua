...
Config.Cooldown = 50 * (60 * 2000) -- where x is minutes ie. x * (60 * 2000) \\ For door auto lock function
Config.Timeout = 50 * (60 * 2000) -- where x is minutes ie. x * (60 * 2000) \\ For case smashing cooldown
...
Config.VangelicoHours = { -- Store Hours
  range = { -- Set both to 0 if you want the store to be robbed 24/7
    open = 12, -- When the doors unlock // Default 6am
    close = 13 -- When they lock for the night // Default 6pm
  },
  alertnight = {
    start = 13, -- The start of higher chance alerts in the evening // Default 6pm
    fin = 23 -- The end of higher chance alerts in the evening // Default 8pm
  },
  alertmorn = {
    start = 23, -- The start of higher chance alerts in the morning // Default 4am
    fin = 12 -- The end of higher chance alerts in the morning // Default 6am
  }
}
...
Config.Stores = {
  [1] = { -- City Vangelico's
    ...
    ['Thermite'] = {
      ...
      coords = vector3(-631.33, -237.35, 38.05),
      h = 35.0,
      minZ = 36.85,
      maxZ = 40.85,
      anim = vector4(-631.0, -237.5, 38.05, 308.5), 
      effect = vector3(-631.0, -237.5, 38.01)
    },
    ['Hack'] = {
...
Config.ThermiteSettings = {
  time = 40, -- time the hack displays for \\ half being showing the puzzle and the other solving
