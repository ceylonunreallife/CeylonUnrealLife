...
Config.Gatos = { -- Coords to spawn cats in jcafe, set sitting to false in order the cat will not sit but move, or set true the cat will sit, add as many cats u want but remove , from } last one
