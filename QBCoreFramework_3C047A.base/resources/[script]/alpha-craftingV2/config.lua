...
Config.CraftingStations = { -- All crafting stations config
    ...
    weaponcrafting = {
        ...
        Coords = vector3(3596.68, 3670.1, 42.61), -- Crafting station coords
        ...
        MapBlip = { -- The blip will be disappear in minimap if you keep Config.MapBlipStatus as true
            ...
            Vector3 = vector3(3596.68, 3670.1, 42.61) -- Crafting station coords

        },

        Target = {

            Vector3 = vector3(3596.84, 3669.95, 42.61),
            Vector3One = 1.35,
            Vector3Two = 2.2,
        ...
        Crafts = {
            ...
            { -- 1
                ...
                Item = "weapon_pistol_mk2", -- Item ID
    ...
    medicalcrafting = {
        ...
        Coords = vector3(0.86, 0.71, 0.12), -- Crafting station coords
        ...
        Target = {
            ...
            Vector3 = vector3(0.72, 0.39, 0.12),
            Vector3One = 1.65,
            Vector3Two = 2.45,
    ...
    misccrafting = {
        ...
        Coords = vector3(0.22, 0.29, 0.98), -- Crafting station coords
        ...
        MapBlip = { -- The blip will be disappear in minimap if you keep Config.MapBlipStatus as true
            ...
            Scale = 0.8, -- Blip scale
            Text = "Crafting Station", -- Blip text
            Vector3 = vector3(0.22, 0.29, 0.98) -- Crafting station coords

        },

        Target = {

            Vector3 = vector3(0.31, 0.18, 0.84),
            Vector3One = 0.85,
            Vector3Two = 2.6,
            ...
            --[[
                ...
                BoxZone:Create(vector3(0.31, 0.18, 0.84), 0.85, 2.6, {
                name="misccrafting",
                heading=359,
                --debugPoly=true,
                minZ=20.84,
