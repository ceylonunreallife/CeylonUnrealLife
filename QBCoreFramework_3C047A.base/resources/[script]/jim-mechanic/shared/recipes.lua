...
Stores = {
	ToolItems = {
		...
		items = {
			{ name = "mechanic_tools", price = 2000, amount = 10, info = {}, type = "item", },
			{ name = "toolbox", price = 5000, amount = 10, info = {}, type = "item", },
			{ name = "ducttape", price = 500, amount = 100, info = {}, type = "item", },
			{ name = "paintcan", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "tint_supplies", price = 1000, amount = 50, info = {}, type = "item", },
			{ name = "underglow_controller", price = 3000, amount = 50, info = {}, type = "item", },
			{ name = "cleaningkit", price = 400, amount = 100, info = {}, type = "item", },
			{ name = "sparetire", price = 3000, amount = 100, info = {}, type = "item", },
			{ name = "axleparts", price = 10000, amount = 1000, info = {}, type = "item", },
			{ name = "carbattery", price = 30000, amount = 1000, info = {}, type = "item", },
			{ name = "sparkplugs", price = 5000, amount = 1000, info = {}, type = "item", },
			{ name = "newoil", price = 12000, amount = 1000, info = {}, type = "item", },
		},
	},
	PerformItems = {
		...
		items = {
			...
			{ name = "engine1", price = 20000, amount = 50, info = {}, type = "item", },
			{ name = "engine2", price = 20000, amount = 50, info = {}, type = "item", },
			{ name = "engine3", price = 20000, amount = 50, info = {}, type = "item", },
			...
			{ name = "transmission4", price = 15000, amount = 50, info = {}, type = "item", },
			{ name = "brakes1", price = 5000, amount = 50, info = {}, type = "item", },
			{ name = "brakes2", price = 7000, amount = 50, info = {}, type = "item", },
			{ name = "brakes3", price = 10000, amount = 50, info = {}, type = "item", },
			{ name = "car_armor", price = 1000000, amount = 50, info = {}, type = "item", },
			{ name = "suspension1", price = 10000, amount = 50, info = {}, type = "item", },
			{ name = "suspension2", price = 16000, amount = 50, info = {}, type = "item", },
			{ name = "suspension3", price = 18000, amount = 50, info = {}, type = "item", },
			{ name = "suspension4", price = 20000, amount = 50, info = {}, type = "item", },
			{ name = "suspension5", price = 22000, amount = 50, info = {}, type = "item", },
			{ name = "bprooftires", price = 800000, amount = 50, info = {}, type = "item", },
			{ name = "drifttires", price = 40000, amount = 50, info = {}, type = "item", },
			{ name = "nos", price = 99999999999999999999999, amount = 50, info = {}, type = "item", },
		},
	},
	StoreItems = {
		...
		items = {
			...
			{ name = "exhaust", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "seat", price = 3000, amount = 50, info = {}, type = "item", },
			{ name = "livery", price = 4000, amount = 50, info = {}, type = "item", },
			{ name = "tires", price = 8000, amount = 50, info = {}, type = "item", },
			{ name = "horn", price = 500, amount = 50, info = {}, type = "item", },
			{ name = "internals", price = 6000, amount = 50, info = {}, type = "item", },
			{ name = "externals", price = 3000, amount = 50, info = {}, type = "item", },
			{ name = "customplate", price = 1000, amount = 50, info = {}, type = "item", },
			{ name = "headlights", price = 2000, amount = 50, info = {}, type = "item", },
			{ name = "rims", price = 6000, amount = 100, info = {}, type = "item", },
			{ name = "rollcage", price = 8000, amount = 50, info = {}, type = "item", },
			{ name = "noscolour", price = 6000, amount = 50, info = {}, type = "item", },
		},
	},
}
