...
Config.Stores = {
    ...
    {
        type = "clothing",
        coords = vector4(300.22, -598.91, 43.28, 335.69),
        ...
        --targetScenario = "" -- overrides the target scenario configure for the group
        points = {
            vector3(300.22, -598.91, 43.28),
            vector3(298.87, -598.62, 43.28),
            vector3(299.98, -596.85, 43.28),
            vector3(301.25, -599.23, 43.28)
        }
    },
    {
        type = "barber",
    ...
    {
        type = "surgeon",
        coords = vector4(0.78, 0.81, 0.26, 0.27),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(0.84417724609, 0.92205810547, 0.26),
            vector3(0.39556884766, 0.65942382812, 0.26),
            vector3(0.56317138672, 0.60675048828, 0.26),
            vector3(0.28656005859, 0.330078125, 0.26)
        }
    }
}
...
Config.ClothingRooms = {
    {
        job = "police",
        coords = vector4(461.14, -999.13, 30.69, 80.6),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(461.57, -999.27, 30.69),
            vector3(459.2, -999.01, 30.69),
            vector3(463.06, -996.67, 30.69),
            vector3(460.42, -996.72, 30.69),
            vector3(457.93, -998.65, 30.69)
        }
    }
}
