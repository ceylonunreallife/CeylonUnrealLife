...
------------------------------------------------------------
	SellItems = { -- Selling Prices
		...
		['emerald_ring_silver'] = 1500,
		['ruby_ring_silver'] = 1300,
		['sapphire_ring_silver'] = 1100,

		['diamond_necklace'] = 2500,
		['emerald_necklace'] = 2400,
		['ruby_necklace'] = 2300,
		['sapphire_necklace'] = 2200,
		['diamond_necklace_silver'] = 2300,
		['emerald_necklace_silver'] = 2200,
		['ruby_necklace_silver'] = 2100,
		['sapphire_necklace_silver'] = 2000,

		['diamond_earring'] = 1400,
		['emerald_earring'] = 1800,
		['ruby_earring'] = 1700,
		['sapphire_earring'] = 1500,
		['diamond_earring_silver'] = 1700,
		['emerald_earring_silver'] = 1500,
		['ruby_earring_silver'] = 1400,
...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "miningdrill",	price = 10000, amount = 50, info = {}, type = "item", slot = 2, },
			{ name = "mininglaser",	price = 60000, amount = 5, info = {}, type = "item", slot = 3, },
			{ name = "drillbit", price = 400, amount = 100, info = {}, type = "item", slot = 4, },
                        { name = "weapon_flashlight", price = 400, amount = 100, info = {}, type = "item", slot = 5, },
		},
	},
}
Crafting = {
